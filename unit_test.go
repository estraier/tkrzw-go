...
func TestIndex(t *testing.T) {
	...
	CheckTrue(t, index.Add("single", "1"))
	CheckTrue(t, index.Add("double", "11"))
	CheckTrue(t, index.Check("single", "1"))
	CheckTrue(t, index.Check("double", "11"))
	CheckTrue(t, index.Add("single", "2"))
	CheckTrue(t, index.Add("double", "22"))
	CheckTrue(t, index.Add("triple", "222"))
	...
	CheckTrue(t, index.Remove("single", "1"))
	CheckTrue(t, index.Remove("double", "11"))
	CheckFalse(t, index.Remove("triple", "x"))
	strValues = index.GetValuesStr("double", 0)
	CheckEq(t, 1, len(strValues))
	CheckEq(t, "22", strValues[0])
	CheckEq(t, 3, index.Count())
	CheckTrue(t, index.Synchronize(false))
	CheckTrue(t, index.Rebuild())
	CheckEq(t, 3, index.Count())
	CheckTrue(t, index.Clear())
	CheckEq(t, 0, index.Count())
	CheckTrue(t, index.IsWritable())
	CheckTrue(t, index.Add("first", "1"))
	CheckTrue(t, index.Add("second", "2"))
	CheckTrue(t, index.Add("third", "3"))
