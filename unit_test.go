...
func TestDBMBasic(t *testing.T) {
	...
	CheckEq(t, StatusSuccess, dbm.Rebuild(ParseParams("")))
	CheckEq(t, StatusSuccess, dbm.Synchronize(true, ParseParams("")))
	...
	CheckEq(t, StatusSuccess, dbm.Open(filePath, true, ParseParams("")))
	copyDBM := NewDBM()
	CheckEq(t, StatusSuccess, copyDBM.Open(copyPath, false, ParseParams("")))
...
func TestAsyncDBM(t *testing.T) {
	...
	CheckEq(t, StatusSuccess, async.Rebuild(ParseParams("")).Get())
	CheckEq(t, StatusSuccess, async.Synchronize(false, ParseParams("")).Get())
	CheckEq(t, StatusSuccess, async.CopyFileData(copyPath, false).Get())
	CheckEq(t, StatusSuccess, async.Clear().Get())
	CheckEq(t, 0, dbm.CountSimple())
	copyDBM := NewDBM()
	CheckEq(t, StatusSuccess, copyDBM.Open(copyPath, true, ParseParams("")))
